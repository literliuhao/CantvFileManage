...
public class MediaMenuListRadiaoItem extends LinearLayout {
    ...
    public MediaMenuListRadiaoItem(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void animateSelection(boolean select) {
        if (select) {
            ...
            MainThread.runLater(new Runnable() {
                ...
                @Override
                public void run() {
                    mImageView.setBackground(getResources().getDrawable(R.drawable.radiaofocus));
                }
            });
            ...
            mTextView.setTextSize(getResources().getDimension(R.dimen.px56));
            mImageView.setBackground(getResources().getDrawable(R.drawable.radiaonomal));
            if (mAnimation != null) {
                mAnimation.cancel();
                mAnimation = null;
            }
