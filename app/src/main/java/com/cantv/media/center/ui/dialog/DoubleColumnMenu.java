...
public class DoubleColumnMenu extends RelativeLayout implements Observer {
    ...
    public interface OnItemClickListener {
        boolean onMenuItemClick(LinearLayout parent, View view, int position);

        void onSubMenuItemClick(LinearLayout parent, View view, int position);
    }

    public interface OnItemFocusChangeListener {
        void onMenuItemFocusChanged(LinearLayout leftViewGroup, View view, int position, boolean hasFocus);

        void onSubMenuItemFocusChanged(LinearLayout rightViewGroup, View view, int position, boolean hasFocus);
    }

    public interface OnKeyEventListener {
        boolean onMenuItemKeyEvent(int position, View v, int keyCode, KeyEvent event);

        boolean onSubMenuItemKeyEvent(int position, View v, int keyCode, KeyEvent event);
    }
    ...
    private void initGlobalData() {
        ...
        mMenuItemViews = new SparseArray<>();
        mSubMenuItemViews = new SparseArray<>();
