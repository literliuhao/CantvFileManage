...
public class CircleProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressUnReachColor = attributes.getColor(R.styleable.CircleProgressBar_bgBarColor, Color.parseColor("#7FFFFFFF"));
        mProgressReachWidth = attributes.getDimensionPixelSize(R.styleable.CircleProgressBar_progressBarWidth, 7);
        mProgressReachColor = attributes.getColor(R.styleable.CircleProgressBar_progressBarColor, Color.parseColor("#32AEFD"));
