    ...
    public void startMoveFocus(View view, Rect clipRect, boolean isScalable, float scale, float scrollerX, float scrollerY) {
        if(view != null) {
            ...
            if(clipRect == null) {
                ...
                pL = ((float)view.getWidth() * scale - (float)view.getWidth()) / 2.0F;
                pT = ((float)view.getHeight() * scale - (float)view.getHeight()) / 2.0F;
                this.focusView.focusMove((float)((int)((float)location[0] - pL + (float)clipRect.left + scrollerX)), (float)((int)((float)location[1] - pT + (float)clipRect.top + scrollerY)), (float)((int)((float)(location[0] + view.getWidth()) + pL - (float)clipRect.right + scrollerX)), (float)((int)((float)(location[1] + view.getHeight()) + pT - (float)clipRect.bottom + scrollerY)));
            } else {
                this.focusView.focusMove((float)(location[0] + clipRect.left) + scrollerX, (float)(location[1] + clipRect.top) + scrollerY, (float)(location[0] + view.getWidth() - clipRect.right) + scrollerX, (float)(location[1] + view.getHeight() - clipRect.bottom) + scrollerY);
            }
