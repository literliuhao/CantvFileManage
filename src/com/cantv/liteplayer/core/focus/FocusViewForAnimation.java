...
public class FocusViewForAnimation extends View implements BaseFocusView {
    ...
    private void startMoveFocus() {
        ...
        ObjectAnimator transAnimatorX = ObjectAnimator.ofFloat(this, "translationX", new float[]{this.frameLeftMoveEnd - (float)this.rectBitmap.left});
        ObjectAnimator transAnimatorY = ObjectAnimator.ofFloat(this, "translationY", new float[]{this.frameTopMoveEnd - (float)this.rectBitmap.top});
        ObjectAnimator scaleXAnimator = ObjectAnimator.ofInt(new FocusViewForAnimation.ScaleView(this), "width", new int[]{(int)this.frameWidth + this.rectBitmap.left + this.rectBitmap.right, (int)this.newFrameWidth + this.rectBitmap.left + this.rectBitmap.right});
        ObjectAnimator scaleYAnimator = ObjectAnimator.ofInt(new FocusViewForAnimation.ScaleView(this), "height", new int[]{(int)this.frameHeight + this.rectBitmap.top + this.rectBitmap.bottom, (int)this.newFrameHeight + this.rectBitmap.top + this.rectBitmap.bottom});
