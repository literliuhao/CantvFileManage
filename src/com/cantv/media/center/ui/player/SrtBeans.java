...
public class SrtBeans implements Comparable<Long> {
	...
	public static Pattern matchTimePattern = Pattern
			.compile("(\\d{1,2}:\\d{1,2}:\\d{1,2},\\d{1,3}).*(\\d{1,2}:\\d{1,2}:\\d{1,2},\\d{1,3})");
	public static Pattern convertTimePattern = Pattern
			.compile("(\\d{1,2}):(\\d{1,2}):(\\d{1,2}),(\\d{1,3})");
