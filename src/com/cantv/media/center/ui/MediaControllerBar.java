...
import com.cantv.media.center.ui.MediaProgressBar.MediaProgressBarDragListener;
import com.cantv.media.R;

public class MediaControllerBar extends FrameLayout implements
		MediaProgressBarDragListener {
	...
	private List<Media> mDataList = new LinkedList<Media>();
	...
	public MediaControllerBar(Context context, AttributeSet attrs, int defStyle) {
		...
		mPlayOrPauseView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mPlayer != null) {
					...
					int resId = mPaused ? R.drawable.general__share__play
							: R.drawable.general__share__pause;
		...
		mRewindView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (mPlayer != null) {
					long maxDuration = Math.max(mPlayer.getDuration(),
							mProgressBar.getMaxProgress());
					long curDuration = Math.max(mPlayer.getCurrentPosition(),
							mProgressBar.getCurrentProgress());
	...
	public void setPlayer(LitePlayer player, boolean playByLoop, int index,
			boolean ispaused, MediaPlayListener playListener) {
...
//			return mProgressBar.onKeyPressedContinuity(keyCode, event);
	...
	private void flyView(float from, float to, int duration,
