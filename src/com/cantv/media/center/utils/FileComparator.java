    ...
    public int compare(Media media1, Media media2) {
        switch (mSoryType) {
            case SORT_TYPE_DATE_UP:
                return sort(media1, media2, (int) (media1.modifiedDate - media2.modifiedDate), SORT_MODE_UP);
            case SORT_TYPE_DATE_DOWN:
                return sort(media1, media2, (int) (media1.modifiedDate - media2.modifiedDate), SORT_MODE_DOWN);
            case SORT_TYPE_SIZE_UP:
                return sort(media1, media2, (int) (media1.fileSize - media2.fileSize), SORT_MODE_UP);
            case SORT_TYPE_SIZE_DOWN:
                return sort(media1, media2, (int) (media1.fileSize - media2.fileSize), SORT_MODE_DOWN);
